...
- `npm run test:inkwell-frontier-demo` delegates to the root Inkwell Frontier app gates so the app-specific editor lives outside reusable design-system package code.
